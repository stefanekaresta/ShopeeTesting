angular
    .module('altairApp')
    .controller('fileDetailOutCtrl',
    function ($rootScope,$scope,$interval,$timeout,$compile,$log,ReconstructMenu,FileDetailOutputProcess) {
        ...
        $timeout(function(){
            ...
            FileDetailOutputProcess.GetListData().then(success_get_data,error_get_data);
        },500);
    ...
    .factory('FileDetailOutputProcess', function($timeout,$log,$http,ServerConfig,$q){
        var service = {};
