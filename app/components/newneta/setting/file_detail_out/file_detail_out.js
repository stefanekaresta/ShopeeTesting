angular
    ...
    .controller('tablesorterCtrl', [
        ...
        'ReconstructMenu',
        '$log',
        function ($scope,$rootScope,$timeout,$compile,variables,ts_data,ActionProcessFDO,ReconstructMenu,$log) {
            ReconstructMenu.Init();

            $scope.dataListOutputAll = [];
            ...
            ActionProcessFDO.GetListData().then(success_get_data,error_get_data);
            //---------------------------------------------------------------------------------------------------------
            ...
            $scope.saveData = function() {
                ...
                ActionProcessFDO.UpdateData($scope.selectedData).then(success_edit,error_edit);
            };
    ...
    .factory('ActionProcessFDO', function($timeout,$log,$http,ServerConfig,$q){
        var service = {};

        var agent_process = {
            method: 'GET',
            url: ServerConfig.production + '/neta/wifiid/search/file_detail_output_all',
            headers: {}
        };
        ...
        var update_data = {
            method: 'POST',
            url: ServerConfig.production + '/neta/wifiid/update/file_detail_output',
            data:{},
            headers: {}
        };
