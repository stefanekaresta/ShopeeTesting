angular
    .module('altairApp')
    .controller('aggCustomCtrl',
    function($compile, $scope, $timeout, $resource, DTOptionsBuilder,DTColumnBuilder,
             DTColumnDefBuilder, $log,ngTableParams, $filter, AggregationFactory,ReconstructMenu) {
        ...
        vm.dtColumnDefs = [
            ...
            DTColumnDefBuilder.newColumnDef(0).withTitle('fileTypeId'),
            DTColumnDefBuilder.newColumnDef(1).withTitle('recordId'),
            DTColumnDefBuilder.newColumnDef(2).withTitle('sortBy'),
            DTColumnDefBuilder.newColumnDef(3).withTitle('datePattern')
        ...
        vm.dtOptions = DTOptionsBuilder
            ...
            //.withOption('rowCallback', rowCsallback)
